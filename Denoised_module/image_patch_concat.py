...
if __name__ == '__main__':
    model_weights_path = "D:\\project\\phase_structure\\logs\\VanillaVAE\\version_1\\checkpoints\\last.ckpt"
    image_folder_path = [os.path.join('D:\\test', im) for im in os.listdir('D:\\test')]
    image_output_folder_path = "C:\\Users\\yyt70\\Desktop\\paper_data\\test_real"
