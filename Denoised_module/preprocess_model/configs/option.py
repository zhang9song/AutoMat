...
parser.add_argument('--config', '-c', dest="filename", metavar='FILE', help='path to the config file',
                    default='/home/aiprogram/project/yaotian/phase_structure_reconstruction/preprocess_model/configs/vae.yaml')
parser.add_argument('--dir_data', type=str,
                    default='/home/aiprogram/project/yaotian/phase_structure_reconstruction/STEM_data_ZrO_0304',
