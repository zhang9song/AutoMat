...
# 输出聚类结果的 JSON 文件路径
output_json = '/home/aiprogram/project/yaotian/phase_structure_reconstruction/data_generation/binary_cif_clusters.json'
...
# ---------------------------
# 聚类：利用 KMeans 将结构分为指定数量的类（此处 n_clusters = 2）
# ---------------------------
...
plt.xlabel("PC1")
plt.ylabel("PC2")
plt.title("CIF 结构投影降维及聚类结果 (聚类数 = 2)")
