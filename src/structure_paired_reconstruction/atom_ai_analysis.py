...
def process_image(image_path):
    ...
    output_file = base_name + "_reconstructed.cif"
...
if __name__ == '__main__':
    ...
    # 重建流程：单张图像重建流程
    # ------------------------------------------------------------------
    image_path = "/home/aiprogram/project/yaotian/phase_structure_reconstruction/data_generation/simulate_data/label/orthogonal_2dm-767_supercell_12x12x1_dose60000_sampling0.1_iDPC_V3.png"  # 请将此处替换为实际的输入PNG文件路径
    atoms, output_path = process_image(image_path)
    ...
    # 调用可视化函数
    # visualize_results(image_path, output_path)